...
sim = SingleCavitationSimulation;
sim.microbubble_location_x = 100;
sim.microbubble_location_y = 40;
sim.microbubble_location_z = 40;
sim.microbubble_true_location_x = kgrid.x(sim.microbubble_location_x, sim.microbubble_location_y, sim.microbubble_location_z);
sim.microbubble_true_location_y = kgrid.y(sim.microbubble_location_x, sim.microbubble_location_y, sim.microbubble_location_z);
...
sim.kgrid = kgrid;
sim.medium = medium;
sim.true_kwavearray = karray;
sim.true_source_signal = source_sig;
